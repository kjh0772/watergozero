...
#### Waveshare RPi Relay Board (B) 8ch 동시 출력 (라즈베리파이)

라즈베리파이에서 [Waveshare RPi Relay Board (B)](https://www.waveshare.com/wiki/RPi_Relay_Board_(B)#WiringPi) 8채널을 사용할 때, **1032~1039(앞 8코일)가 보드의 Ch1~Ch8과 1:1로 동시에 출력**됩니다. Modbus(PLC) 쓰기와 GPIO 출력이 함께 수행됩니다.

| PLC 주소 | 배열 인덱스 | 릴레이 보드 채널 | BCM 핀 | 용도 |
|----------|-------------|------------------|--------|------|
| 1032 | 0 | Channel 1 | 5 | 펌프 (P1) |
| 1033 | 1 | Channel 2 | 6 | 밸브 0 (구역 1) |
| 1034 | 2 | Channel 3 | 13 | 밸브 1 (구역 2) |
| 1035 | 3 | Channel 4 | 16 | 밸브 2 (구역 3) |
| 1036 | 4 | Channel 5 | 19 | 밸브 3 (구역 4) |
| 1037 | 5 | Channel 6 | 20 | 밸브 4 (구역 5) |
